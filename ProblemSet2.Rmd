...
ggplot2::ggsave("P7_rd_placebo_graduated2021.png", plot = p7$rdplot, width = 8, height = 6, dpi = 300)
```
...
# --- Guardar el gráfico en alta resolución ---
ggsave("P8_rd_placebo_cov_graduated2021.png", plot = p8$rdplot, width = 8, height = 6, dpi = 300)
```
