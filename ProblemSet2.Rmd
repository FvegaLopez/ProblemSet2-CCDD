...
# Extraer tabla de resultados principales (tests)
df_res <- as.data.frame(res$tests)
df_res$Method <- rownames(res$tests)

# Guardar en HTML
df_res %>%
  kbl(caption = "Test de densidad en el cutoff") %>%
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover")) %>%
  save_kable("outputs/P1_rddensity_test.html")
