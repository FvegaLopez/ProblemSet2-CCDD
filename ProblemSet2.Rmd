...
ggsave("./outputs/P3_graf_enrolado.png", g1, width = 7, height = 5, dpi = 300)
ggsave("./outputs/P3_graf_graduado.png", g2, width = 7, height = 5, dpi = 300)

# Combinar y guardar juntos
g_combined <- ggarrange(g1, g2, ncol = 2, nrow = 1)
g_combined
ggsave("./outputs/P3_grapf_combinado.png", g_combined, width = 12, height = 5, dpi = 300)
...
ggsave("./outputs/P5_graf_cuad.png", g_cuad, width = 7, height = 5, dpi = 300)
ggsave("./outputs/P5_graf_cubic.png", g_cubic, width = 7, height = 5, dpi = 300)

# Combinar y guardar juntos (lado a lado)
g_combinado <- ggarrange(g_cuad, g_cubic, ncol = 2, nrow = 1)
g_combinado
ggsave("./outputs/P5_graf_cuad_cubic_combinado.png", g_combinado, width = 12, height = 5, dpi = 300)
