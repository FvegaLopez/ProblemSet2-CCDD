...
# Modelo con efectos fijos de escuela
model_firststage_fe <- feols(
  ListedInDropoutReport ~ DroppedOutMay30Before * SchoolDaysFromMay302022 | IDschool,
  data = bbdd
)

summary(model_firststage_fe)


#c)

ggplot(bbdd, aes(x = DayOfWeekDroppedOut)) +
  geom_bar(fill = "lightblue", color = "black") +
  labs(title = "Frecuencia de retiros por día de la semana",
